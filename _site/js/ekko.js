...
(function() {
  ...
  EkkoLightbox = function(element, options) {
    ...
    header = '<div class="modal-header"' + (this.options.title || this.options.always_show_close ? '' : ' style="display:none"') + '><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><p class="modal-title">' + (this.options.title || "&nbsp;") + '</p></div>';
